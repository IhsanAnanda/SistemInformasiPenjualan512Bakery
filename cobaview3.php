...
<div class="container-fluid">
	...
	<tr>
		<th colspan="5"><h3><b>Daftar Karyawan 512 Bakery</b></h3></th>
		<?php
		if ($cek > 0) {
		?>
		<th><a class="fas fa-plus-circle fa-2x aqua-gradient-text mr-2" href=cobaregistrasi.php>
		</a>
		</th>
		<?php
		}else{
	...
	<tr>
		<th><h5><b>No.</b></h5></th>
		<th><h5><b>Username</b></h5></th>
		<th><h5><b>Password</b></h5></th>
		<th><h5><b>Nama Karyawan</b></h5></th>
	...
	<tr>
		...
		if ($cek > 0) {
		?>
		<a class="far fa-edit fa-lg green-text mr-2" href="<?php echo "cobaupdate3.php?username=".$data['username'];?>"></a>
		<?php
			if ($username != $data['username']) {
		?>
			<a class="far fa-trash-alt fa-lg red-text mr-2" href="<?php echo "cobahapus5.php?username=".$data['username']?>"></a>
		<?php
		};
		?>
		<?php

  ...
  <div class="col-md-3">
    ...
    <div class="sidebar-fixed position-fixed side-nav fixed elegant-color-dark custom-scrollbar">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="cobalagi.php" class="list-group-item active waves-effect">
...
<!--   content -->
  <div class="col-md-10">
    ...
    <col width="135px" />
		<tr>
			<th colspan="7"><h4><b>Input Data Transaksi</b></h4></th>
		</tr>
		<tr>
			<th colspan="4">
			...
			<th>
				<a class="fas fa-sync fa-2x aqua-gradient-text mr-2" href="<?php echo"ClearDumm.php";?>"></a>
			</th>
		</tr>
		<tr>
			<th>Nomor</th>
		...
		<tr>
			...
			<td>
			<a class="far fa-trash-alt fa-lg red-text mr-2" href="<?php echo "cobahapus.php?kode_menu=".$value['kode_menu']?>">
			</a>
			</td>
		</tr>
		<?php
...
if(isset($_POST['submit'])){
    ...
    (tanggal, pelanggan, total, bayar, kembali, username) VALUES
    (now(), '$pelanggan', '$total', '$bayar', $kembali, '$username')");
...
elseif (isset($_POST['add'])) {
	...
	if ($cek>0) {
		...
		echo "<script type='text/javascript'>
    	window.open('http://localhost/PWPraktikum/KP_512Bakery/cobalagi.php','_self');</script>";
	}
	else{

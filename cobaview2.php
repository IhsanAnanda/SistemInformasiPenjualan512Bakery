...
<div class="container-fluid">
  ...
  <!-- content -->
  <div class="col-md-10">
  <table class="table-hover text-wrap">
  <tr>
    <th colspan="4"><h3><b>Daftar Kategori Menu 512 Bakery</b></h3></th>
    <th>
    <?php 
    if ($cek > 0) {
    ?>
    <a class="fas fa-plus-circle fa-2x aqua-gradient-text mr-2" href="<?php echo "cobalagi2.php";?>"></a>
    <?php
    }
    ?>
    </th>
  ...
  <tr>
    <th><h5><b>No.</b></h5></th>
    <th><h5><b>Id Kategori</b></h5></th>
    <th><h5><b>Nama Kategori</b></h5></th>
    <th><h5><b>Keterangan</b></h5></th>
    <th><h5><b>Opsi</b></h5></th>
  </tr>
  <?php
  $nomor = 1;
  foreach ($result as $key => $data) {
  $dataMenu = mysqli_query($conn, "SELECT * FROM tb_menu WHERE id_kategori='".$data['id_kategori']."' ");
  ...
  <tr>
    ...
    if ($cek > 0) {
    ?>
    <a class="far fa-edit fa-lg green-text mr-2" href="<?php echo "cobaupdate2.php?id_kategori=".$data['id_kategori'];?>"></a>
    <?php  if ($angka == 0) {  ?>
      <a class="far fa-trash-alt fa-lg red-text mr-2" href="<?php echo "cobahapus2.php?id_kategori=".$data['id_kategori']?>"></a>
    <?php }?>
    <?php
    }
    else{

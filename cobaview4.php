...
$kembali = $trans1['kembali'];
$temp = $trans1['no_trans'];
$total = $trans1['total'];
$bayar = $trans1['bayar'];
$ket = $trans1['ket'];
  ...
  <div class="col-md-10">
    ...
    <col width="144px" />
		...
		<tr>
			...
			<th><input type="submit" name="submit" value="Cetak" class="btn btn-primary btn-sm"
				onclick=""></th>
		</tr>
		<tr>
			<th colspan="2">
		...
		<tr>
			...
			<th colspan="2">Rp. <?php echo number_format($kembali); ?></th>
		</tr>
	</table>

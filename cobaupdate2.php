...
$update = mysqli_query($conn,"SELECT * FROM tb_kategori WHERE id_kategori='$id_kategori'");
...
if(isset($_POST['submit'])){
	...
	$result = mysqli_query($conn, "UPDATE tb_kategori
		SET nama_kategori='$nama', ket_kategori='$keterangan' WHERE id_kategori='$id'");
...
<div class="row">
  ...
  <div class="col-md-10">
	...
	<table>
		<tr>
			<th colspan="3"><h4><b>Update Data Kategori Menu</b></h4></th>
		</tr>
		<tr>
			<td>Id Kategori</td>
			<td>:</td>
			<td><input type="text" name="id" value="<?php echo $data['id_kategori']; ?>" readonly>
			</td>
		</tr>
		<tr>
			<td>Nama Kategori</td>
			<td>:</td>
			<td><input type="text" name="nama" value="<?php echo $data['nama_kategori']; ?>"></td>
		</tr>
		<tr>
			<td>Keterangan</td>
			<td>:</td>
			<td>
			<input type="text" name="keterangan" value="<?php echo $data['ket_kategori']; ?>">
			</td>
		</tr>
		<tr>
			<td colspan="3">
